...
// TODO[migrate]: <img /> replaced with plain <img />
        ...
        <nav className="hidden justify-between lg:flex">
          <div className="flex items-center gap-6">
            <Link to={logo.url} className="flex items-center gap-2">
              <img width={100} height={100} src={logo.src} className="w-8" alt={logo.alt} />
            </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Auth Buttons */}
            <Button variant="outline" size="sm" asChild><a href={auth.login.url}>{auth.login.text}</a></Button>
            <Button size="sm" asChild><a href={auth.signup.url}>{auth.signup.text}</a></Button>
          </div>
        </nav>
        ...
        <div className="block lg:hidden">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Menu Sheet */}
              <Sheet>
                <SheetTrigger asChild><Button variant="ghost" size="icon"><Menu className="size-4" /></Button></SheetTrigger>
                <SheetContent className="overflow-y-auto">
                  ...
                  <div className="my-6 flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-3">
                      <Button variant="outline" asChild><a href={auth.login.url}>{auth.login.text}</a></Button>
